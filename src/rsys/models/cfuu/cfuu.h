...
namespace rsys {
    ...
    T cfuu<T>::predict(size_t user_id, size_t item_id) noexcept {
        return _aggregator->aggregate(_data, user_id, item_id);
    }
